# Administrating and updating the shiny server

This documentation is intended to be used by members of [reside](https://reside-ic.github.io/) when they are working with the shiny server.  If you are a researcher in DIDE (or Imperial in general) looking to host an application you are in the wrong place, you might want the [`README.md`](README.md) instead.
...
1. The user adds provisioning information to their repository, describing packages that their application required, described in [`twinkle`](https://mrc-ide.github.io/twinkle/#packages)
